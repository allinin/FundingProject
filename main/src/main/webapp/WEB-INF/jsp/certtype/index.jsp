                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                            <c:forEach items="${queryAllCerts}" var="cert">
                            <tr>
                                <td>${cert.name}</td>
...
<script type="text/javascript">
    ...
    <c:forEach items="${certAcctType}" var="certAcct">
      $(":checkbox[certid='${certAcct.certid}'][accttype='${certAcct.accttype}']")[0].checked=true
    </c:forEach>
